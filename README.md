...
# Table of Contents  
 - [DAY 1: Inception of Open-source EDA, OpenLane and Sky130 PDK](https://github.com/akashkiran/Advanced-Physical-Design-using-OpenLane-SKY130#day-1---inception-of-open-source-eda-openlane-and-sky130-pdk)
   - [ASIC design Flow](https://github.com/akashkiran/Advanced-Physical-Design-using-OpenLane-SKY130#asic-design-flow)
   - [What is Openlane?](https://github.com/akashkiran/Advanced-Physical-Design-using-OpenLane-SKY130#what-is-openlane)
   - [OpenLane Directory Hierarchy](https://github.com/akashkiran/Advanced-Physical-Design-using-OpenLane-SKY130#openlane-directory-hierarchy)
   - [Lab [Day 1] - Determine Flip-flop Ratio](https://github.com/akashkiran/Advanced-Physical-Design-using-OpenLane-SKY130#lab-day-1---determine-flip-flop-ratio)
   
 - [DAY 2: Good Floorplan vs Bad Floorplan and Introduction to Library Cells](https://github.com/akashkiran/Advanced-Physical-Design-using-OpenLane-SKY130#day-2-good-floorplan-vs-bad-floorplan-and-introduction-to-library-cells)
   - [Floorplan Stage](https://github.com/akashkiran/Advanced-Physical-Design-using-OpenLane-SKY130#floorplan-stage)
   - [Placement Stage](https://github.com/akashkiran/Advanced-Physical-Design-using-OpenLane-SKY130#placement-stage)
   - [Lab [Day 2] - Determine Die Area](https://github.com/akashkiran/Advanced-Physical-Design-using-OpenLane-SKY130#lab-day-2---determine-die-area)
    - [Library Characterization](https://github.com/akashkiran/Advanced-Physical-Design-using-OpenLane-SKY130#library-characterization)
    - [Timing Characterization](https://github.com/akashkiran/Advanced-Physical-Design-using-OpenLane-SKY130#timing-characterization)
     
 - [DAY 3: Design a Library Cell using Magic Layout and Ngspice Characterization](https://github.com/akashkiran/Advanced-Physical-Design-using-OpenLane-SKY130#day-3-design-a-library-cell-using-magic-layout-and-ngspice-characterization)
   - [Designing a Library Cell](https://github.com/akashkiran/Advanced-Physical-Design-using-OpenLane-SKY130#designing-a-library-cell)
     - [SPICE Deck Netlist Description](https://github.com/akashkiran/Advanced-Physical-Design-using-OpenLane-SKY130#spice-deck-netlist-description)
     - [SPICE Analysis for Switching Threshold and Propagation Delay](https://github.com/akashkiran/Advanced-Physical-Design-using-OpenLane-SKY130#spice-analysis-for-switching-threshold-and-propagation-delay)
   - [CMOS Fabrication Process (16-Mask CMOS Process)](https://github.com/akashkiran/Advanced-Physical-Design-using-OpenLane-SKY130#cmos-fabrication-process-16-mask-cmos-process)
   - [Lab [DAY 3] - Introduction to Sky130 basic layers layout and LEF using inverter](https://github.com/akashkiran/Advanced-Physical-Design-using-OpenLane-SKY130#lab-day-3---introduction-to-sky130-basic-layers-layout-and-lef-using-inverter)
   
 - [DAY 4: Pre-layout Timing Analysis and Importance of Good Clock Tree](https://github.com/akashkiran/Advanced-Physical-Design-using-OpenLane-SKY130#day-4-pre-layout-timing-analysis-and-importance-of-good-clock-tree)
   - [Lab [Day 4] - Extracting the LEF File](https://github.com/akashkiran/Advanced-Physical-Design-using-OpenLane-SKY130#lab-day-4---extracting-the-lef-file)
   - [Plug-in the Customized Inverter Cell to OpenLane](https://github.com/akashkiran/Advanced-Physical-Design-using-OpenLane-SKY130#plug-in-the-customized-inverter-cell-to-openlane)
   - [Delay Table](https://github.com/akashkiran/Advanced-Physical-Design-using-OpenLane-SKY130#delay-table)
   - [Fix Negative Slack](https://github.com/akashkiran/Advanced-Physical-Design-using-OpenLane-SKY130#fix-negative-slack)
   - [Locating the Custom Inverter Cell in Layout](https://github.com/akashkiran/Advanced-Physical-Design-using-OpenLane-SKY130#locating-the-custom-inverter-cell-in-layout)
   - [Setup Timing Analysis](https://github.com/akashkiran/Advanced-Physical-Design-using-OpenLane-SKY130#setup-timing-analysis-)
   - [Clock Tree Synthesis Stage](https://github.com/akashkiran/Advanced-Physical-Design-using-OpenLane-SKY130#clock-tree-synthesis-stage)
   - [Timing Analysis with Real Clocks](https://github.com/akashkiran/Advanced-Physical-Design-using-OpenLane-SKY130#timing-analysis-with-real-clocks)
   - [Multi-corner STA for Post-CTS](https://github.com/akashkiran/Advanced-Physical-Design-using-OpenLane-SKY130#multi-corner-sta-for-post-cts)
    
 - [DAY 5: Final Steps for RTL2GDS using TritonRoute and OpenSTA](https://github.com/akashkiran/Advanced-Physical-Design-using-OpenLane-SKY130#day-5-final-steps-for-rtl2gds-using-tritonroute-and-opensta)
   - [Maze Routing - Lee's Algorithm](https://github.com/akashkiran/Advanced-Physical-Design-using-OpenLane-SKY130#maze-routing---lees-algorithm)
   - [DRC Cleaning](https://github.com/akashkiran/Advanced-Physical-Design-using-OpenLane-SKY130#drc-cleaning)
   - [Routing Stage and TritonRoute](https://github.com/akashkiran/Advanced-Physical-Design-using-OpenLane-SKY130#routing-stage-and-tritonroute)
   - [Lab [Day 5] - Power Distribution Network (PDN) and routing](https://github.com/akashkiran/Advanced-Physical-Design-using-OpenLane-SKY130#lab-day-5---power-distribution-network-pdn-and-routing)
   - [SPEF Extraction and GDSII Streaming](https://github.com/akashkiran/Advanced-Physical-Design-using-OpenLane-SKY130#spef-extraction-and-gdsii-streaming)
